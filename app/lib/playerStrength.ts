  ...
  switch (tier) {
    ...
    case 'platinum':
      return {
        ...
        cardClassName: '',
        cardStyle: {
          background: 'linear-gradient(135deg, #0c4a6e 0%, #0f766e 50%, #0c4a6e 100%)',
          boxShadow: '0 0 16px 4px rgba(56,189,248,0.45), 0 0 32px 8px rgba(14,165,233,0.25)',
          color: '#e0f2fe',
        },
        tierLabel: 'プラチナ',
        tierEmoji: '🩵',
    ...
    case 'gold':
      return {
        ...
        cardStyle: {
          ...
          boxShadow: '0 0 16px 5px rgba(251,191,36,0.45), 0 0 30px 8px rgba(217,119,6,0.25)',
          color: '#fef3c7',
        },
        tierLabel: 'ゴールド',
        tierEmoji: '⭐',
    ...
    case 'silver':
      return {
        ...
        cardStyle: {
          ...
          boxShadow: '0 0 12px 3px rgba(203,213,225,0.3)',
          color: '#f8fafc',
        },
        tierLabel: 'シルバー',
        tierEmoji: '🔘',
    ...
    case 'bronze':
      return {
        ...
        cardClassName: '',
        cardStyle: {
          background: 'linear-gradient(135deg, #2d1500 0%, #452200 50%, #2d1500 100%)',
          boxShadow: '0 0 12px 3px rgba(217,119,6,0.3)',
          color: '#ffedd5',
        },
        tierLabel: 'ブロンズ',
        tierEmoji: '🟫',
    ...
    default:
      return {
        ...
        cardClassName: '',
        cardStyle: {
          background: 'linear-gradient(135deg, #3f0712 0%, #5f0713 50%, #3f0712 100%)',
